...
public class JourneyBuilder {
    ...
    public List<EventRequestDto> buildCompleteJourney(String userId, String sessionId, LocalDateTime startTime, String category) {
    ...
    public List<EventRequestDto> buildPartialJourney(String userId, String sessionId, LocalDateTime startTime, String category, int maxStage) {
        List<EventRequestDto> events = new ArrayList<>();
